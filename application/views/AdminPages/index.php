			...
			<div class="col-md-4 span_8">
				<div class="activity_box">
					...
					<div class="scrollbar scrollbar1" id="style-2">
						...
						<div class="activity-row">
							<div class="col-xs-3 activity-img"><img src='<?php echo base_url(); ?>assats/admincss/images/5.png' class="img-responsive" alt=""/></div>
							<div class="col-xs-7 activity-desc">
						...
						<div class="activity-row">
							<div class="col-xs-3 activity-img"><img src='<?php echo base_url(); ?>assats/admincss/images/3.png' class="img-responsive" alt=""/></div>
							<div class="col-xs-7 activity-desc">
						...
						<div class="activity-row">
							<div class="col-xs-3 activity-img"><img src='<?php echo base_url(); ?>assats/admincss/images/4.png' class="img-responsive" alt=""/></div>
							<div class="col-xs-7 activity-desc">
